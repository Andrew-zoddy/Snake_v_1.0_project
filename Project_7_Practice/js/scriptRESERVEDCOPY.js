...
// set best score first in local storage !!! 
...
// START GAME transfering to game field on click  and starting game 
startBtn.addEventListener('click', ()=>{
    // localstorage remove scores
    //score array.push.object
    // local storage .setitem('scores') , JSON.stringify(scoreArr))
